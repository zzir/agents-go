...
`agents-go` is a Go port of the [OpenAI Agents SDK for Python](https://openai.github.io/openai-agents-python/) (tracking v0.17.4). It lets you build agentic AI apps with a small set of primitives and very few abstractions:
